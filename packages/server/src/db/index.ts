...
export class SpamDetectionDatabase {
   ...
   */
  getChallengeSessionByChallengeId(
    challengeId: string
  ...
  upsertIpRecord(params: {
    ...
    const existing = this.getIpRecordByIpAndAuthor(
      params.ipAddress,
      params.author
    );
